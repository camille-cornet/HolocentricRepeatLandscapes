...
export SQLITE_TMPDIR=/data3/camille/repeatexplorer/carex/temp
export TMPDIR=/data3/camille/repeatexplorer/carex/temp
export TEMP=/data3/camille/repeatexplorer/carex/temp
### Change source code so that temporary files are stored in $TEMP instead of /tmp
# In r2py: adding to R CMD command: --RS-workdir /data3/camille/repeatexplorer/carex/A5_comparative_repeats/temp
# In seqtools.py: change TMP_DIR="/data3/camille/repeatexplorer/carex/A5_comparative_repeats/temp"
### IMPORTANT! I have to change the species name in the source code manually everytime 
...
### Also first need to do the manual curation...
